...
- Миграция v2 проверена на синтетической базе в тестах, но **не на реальной
  базе владельца**. Первый запуск новой сборки её выполнит. Копию базы стоит
  сделать до него — кнопка «Копия базы» появилась в панели проекта, но она
  доступна только после запуска новой сборки, то есть уже после миграции.
  Это неудачная последовательность; ручная копия
  `~/Library/Application Support/com.hamidkazimov.magnetar/magnetar.sqlite`
  перед запуском снимает риск.
